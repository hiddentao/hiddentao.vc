...
module.exports = {
  siteMetadata: {
    ...
    description: `London-based investor focusing on cryptocurrency and early-stage startups.`,
    author: `@hiddentao`,
    defaultLanguage,
    supportedLanguages,
  },
  plugins: [
    ...
    // manifest file
    {
      ...
      options: {
        name: `Hiddentao Ventures`,
        short_name: `hiddentao.vc`,
        start_url: `/`,
    ...
    // feed
    {
      ...
      options: {
        ...
        setup: ({ query: { site: { siteMetadata: { title, description, siteUrl } } } }) => ({
          title,
          description,
          feed_url: 'http://feedpress.me/hiddentao-ventures',
          site_url: siteUrl,
